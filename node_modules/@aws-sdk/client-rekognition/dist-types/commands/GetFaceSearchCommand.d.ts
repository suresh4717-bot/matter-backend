...
import type { GetFaceSearchRequest, GetFaceSearchResponse } from "../models/models_0";
...
declare const GetFaceSearchCommand_base: {
    new (input: GetFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<GetFaceSearchCommandInput, GetFaceSearchCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<GetFaceSearchCommandInput, GetFaceSearchCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
