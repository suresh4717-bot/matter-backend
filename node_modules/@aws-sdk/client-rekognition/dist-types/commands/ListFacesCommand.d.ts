...
import type { ListFacesRequest, ListFacesResponse } from "../models/models_0";
...
declare const ListFacesCommand_base: {
    new (input: ListFacesCommandInput): import("@smithy/core/client").CommandImpl<ListFacesCommandInput, ListFacesCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListFacesCommandInput): import("@smithy/core/client").CommandImpl<ListFacesCommandInput, ListFacesCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
