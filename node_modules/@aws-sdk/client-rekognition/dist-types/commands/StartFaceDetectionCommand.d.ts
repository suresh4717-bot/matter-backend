...
import type { StartFaceDetectionRequest, StartFaceDetectionResponse } from "../models/models_0";
...
declare const StartFaceDetectionCommand_base: {
    new (input: StartFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartFaceDetectionCommandInput, StartFaceDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartFaceDetectionCommandInput, StartFaceDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
