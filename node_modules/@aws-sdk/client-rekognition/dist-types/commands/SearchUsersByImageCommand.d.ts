...
import type { SearchUsersByImageRequest, SearchUsersByImageResponse } from "../models/models_0";
...
declare const SearchUsersByImageCommand_base: {
    new (input: SearchUsersByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersByImageCommandInput, SearchUsersByImageCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: SearchUsersByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersByImageCommandInput, SearchUsersByImageCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
