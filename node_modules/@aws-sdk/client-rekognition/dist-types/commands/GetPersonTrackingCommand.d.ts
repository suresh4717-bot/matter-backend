...
import type { GetPersonTrackingRequest, GetPersonTrackingResponse } from "../models/models_0";
...
declare const GetPersonTrackingCommand_base: {
    new (input: GetPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<GetPersonTrackingCommandInput, GetPersonTrackingCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<GetPersonTrackingCommandInput, GetPersonTrackingCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
