...
import type { DetectFacesRequest, DetectFacesResponse } from "../models/models_0";
...
declare const DetectFacesCommand_base: {
    new (input: DetectFacesCommandInput): import("@smithy/core/client").CommandImpl<DetectFacesCommandInput, DetectFacesCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DetectFacesCommandInput): import("@smithy/core/client").CommandImpl<DetectFacesCommandInput, DetectFacesCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
