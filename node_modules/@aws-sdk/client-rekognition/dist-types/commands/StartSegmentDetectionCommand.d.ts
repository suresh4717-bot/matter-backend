...
import type { StartSegmentDetectionRequest, StartSegmentDetectionResponse } from "../models/models_0";
...
declare const StartSegmentDetectionCommand_base: {
    new (input: StartSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartSegmentDetectionCommandInput, StartSegmentDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartSegmentDetectionCommandInput, StartSegmentDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
