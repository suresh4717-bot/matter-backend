...
import type { StartCelebrityRecognitionRequest, StartCelebrityRecognitionResponse } from "../models/models_0";
...
declare const StartCelebrityRecognitionCommand_base: {
    new (input: StartCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<StartCelebrityRecognitionCommandInput, StartCelebrityRecognitionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<StartCelebrityRecognitionCommandInput, StartCelebrityRecognitionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
