...
import type { GetSegmentDetectionRequest, GetSegmentDetectionResponse } from "../models/models_0";
...
declare const GetSegmentDetectionCommand_base: {
    new (input: GetSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetSegmentDetectionCommandInput, GetSegmentDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetSegmentDetectionCommandInput, GetSegmentDetectionCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
