...
import type { DetectCustomLabelsRequest, DetectCustomLabelsResponse } from "../models/models_0";
...
declare const DetectCustomLabelsCommand_base: {
    new (input: DetectCustomLabelsCommandInput): import("@smithy/core/client").CommandImpl<DetectCustomLabelsCommandInput, DetectCustomLabelsCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DetectCustomLabelsCommandInput): import("@smithy/core/client").CommandImpl<DetectCustomLabelsCommandInput, DetectCustomLabelsCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
