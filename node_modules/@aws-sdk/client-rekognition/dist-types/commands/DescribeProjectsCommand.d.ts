...
import type { DescribeProjectsRequest, DescribeProjectsResponse } from "../models/models_0";
...
declare const DescribeProjectsCommand_base: {
    new (input: DescribeProjectsCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectsCommandInput, DescribeProjectsCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeProjectsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeProjectsCommandInput, DescribeProjectsCommandOutput, RekognitionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
